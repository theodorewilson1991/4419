...
NS_LOG_COMPONENT_DEFINE ("Project2m1n1");
...
Project2m1n1::CheckThroughput ()
{
  ...
  out.close ();
  packetsReceived = 0;
  Simulator::Schedule (Seconds (1.0), &Project2m1n1::CheckThroughput, this);
}

Ptr <Socket>
Project2m1n1::SetupPacketReceive (Ipv4Address addr, Ptr <Node> node)
{
  ...
  sink->Bind (local);
  sink->SetRecvCallback (MakeCallback ( &Project2m1n1::ReceivePacket, this));
                           ...
                           double dataStart, bool printRoutes, std::string CSVfileName)
{
  ...
  std::string tr_name = "DsdvProjectTrace";
...
void
Project2m1n1::CreateDevices (std::string tr_name)
{
...
void
Project2m1n1::InstallApplications ()
{
